# Operator Quickstart — cloud-itonami-isic-4510

Shortest path from clone to a verified local dry-run for **ISIC 4510** (`cloud-itonami-isic-4510`).
...
```bash
git clone https://github.com/cloud-itonami/cloud-itonami-isic-4510.git
